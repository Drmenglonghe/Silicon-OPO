# -*- coding: utf-8 -*-
"""
Created on Fri Jun 24 16:59:20 2022
...
##########################################################################################################################
f0 = (1.4)/(normal_f**2*neff)
Field1 = np.linspace(0,f0,1000)
d0 = 20e9*(2*np.pi)*(2*tau_ph)
...
plt.contour(delta,Field,z1,0,colors=lighten_color('b', 0.2))
# plt.contour(delta,Field,z2,0,colors=lighten_color('b', 0.2))
plt.contour(delta,Field,z3,0,colors=lighten_color('b', 0.4))
# plt.contour(delta,Field,z4,0,colors=lighten_color('b', 0.4))
plt.contour(delta,Field,z5,0,colors=lighten_color('b', 0.6))
# plt.contour(delta,Field,z6,0,colors=lighten_color('b', 0.6))
plt.contour(delta,Field,z7,0,colors=lighten_color('b', 0.8))
# plt.contour(delta,Field,z8,0,colors=lighten_color('b', 0.8))
plt.contour(delta,Field,z9,0,colors=lighten_color('b', 1))
# plt.contour(delta,Field,z10,0,colors=lighten_color('b', 1))


plt.xlabel(r"Cold detuning ${\Delta}_{0}$ (GHz)")
plt.ylabel(r"Circulating field power $P_{c}$ (W)")
plt.savefig("journal01.png",dpi=1000,bbox_inches='tight')
plt.show
