...
Pump1_powers =np.linspace(0,38,200)       # The pump power as control power
...
cs1 = plt.contour(X, Y, Z1,alpha=1,cmap="Reds",levels = 12)
cs11 = plt.contourf(X, Y, Z1,alpha=1,cmap="Reds",levels = 12)
